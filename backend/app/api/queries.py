...
async def execute_query(request: QueryRequest):
    ...
    try:
        ...
        return QueryResponse(
            answer=result["answer"], sources=citations, execution_time_ms=execution_time_ms
        )
        ...
        raise HTTPException(
            status_code=500, detail="Failed to process query against the document database."
        )
